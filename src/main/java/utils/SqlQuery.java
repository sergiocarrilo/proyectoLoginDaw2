...
public class SqlQuery {
   ...
   public static final String QUERYGETALLPROFESSORS = "SELECT * FROM PROFESORES ";
   public static final String QUERYGETALLALUMNOS = "SELECT * FROM ALUMNOS";
   public static final String QUERYGETALLASIGNATURAS = "SELECT * FROM ASIGNATURAS";
    ...
    //NOTAS DAO
    public static String QUERYGETALLNOTAS = "SELECT NOTAS.ID_ALUMNO, ALUMNOS.NOMBRE, NOTAS.ID_ASIGNATURA, ASIGNATURAS.NOMBRE, NOTAS.NOTA FROM ((NOTAS INNER JOIN ALUMNOS ON NOTAS.ID_ALUMNO = ALUMNOS.ID) INNER JOIN ASIGNATURAS ON NOTAS.ID_ASIGNATURA = ASIGNATURAS.ID) LIMIT 10 OFFSET ?";
