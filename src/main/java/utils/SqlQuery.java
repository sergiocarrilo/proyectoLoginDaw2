...
public class SqlQuery {
    ...
    public static String QUERYGETTAREABYASIG = "SELECT * FROM TAREAS WHERE ID_ASIGNATURA = ?";
    public static String QUERYGETALUMNOSPORASIG = "SELECT * FROM ALUMNOS_ASIGNATURAS WHERE ID_ASIGNATURA = ?";
    public static String QUERYINSERTALUMNOASIG = "INSERT INTO TAREAS_ALUMNOS (ID_TAREAS_ALUMNOS,ID_TAREA,ID_ALUMNO,HECHO) VALUES (null,?,?,0)";
